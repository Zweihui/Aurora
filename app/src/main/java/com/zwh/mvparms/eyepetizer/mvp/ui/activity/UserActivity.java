...
public class UserActivity extends BaseActivity<UserPresenter> implements UserContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    @BindView(com.zwh.mvparms.eyepetizer.R.id.swipeRefreshLayout)
    ...
    public int initView(Bundle savedInstanceState) {
        return com.zwh.mvparms.eyepetizer.R.layout.activity_user;
    }
    ...
    public void setAdapter(DefaultAdapter adapter) {
        ...
        adapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int viewType, Object data, int position) {
                Toast.makeText(UserActivity.this,"点击了",Toast.LENGTH_SHORT).show();
            }
        });
        initRecycleView();
        initPaginate();
