...
public class AuthorTrendFragment extends BaseLazyLoadFragment {
    ...
    public static AuthorTrendFragment newInstance(int id) {
        Bundle arguments = new Bundle();
        arguments.putInt(Constants.AUTHOR_ID, id);
        AuthorTrendFragment fragment = new AuthorTrendFragment();
