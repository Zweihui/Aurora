...
import com.zwh.mvparms.eyepetizer.di.component.DaggerFlutterVideoDetailComponent;
...
/**
 * Created by Zhangwh on 2018/9/12.
 */
@Router(Constants.FLUTTER_VIDEO)
public class FlutterVideoDetailActivity extends BaseActivity<VideoDetailPresenter> implements VideoDetailContract.View, DragBottomView.onDragBottomViewDismissedListener {
    ...
    public void setupActivityComponent(AppComponent appComponent) {
        ...
        DaggerFlutterVideoDetailComponent
                .builder()
...
//        startService(intent);
        Snackbar.make(rlScreen, "视频离线缓存中",Snackbar.LENGTH_LONG)
                .setAction("查看任务", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(FlutterVideoDetailActivity.this, CacheActivity.class);
    ...
    private void initMedia() {
        ...
        detailPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailPlayer.startWindowFullscreen(FlutterVideoDetailActivity.this, true, true);
    ...
    private void checkDownload(View view,VideoListInfo.Video videoInfo){
        Observable.create((ObservableOnSubscribe<Boolean>) e -> {
            ...
            e.onComplete();
        }).compose(RxUtils.applySchedulersWithLifeCycle(FlutterVideoDetailActivity.this))
                .subscribe(new Consumer<Boolean>() {
                               @Override
                               public void accept(@NonNull Boolean aBoolean) throws Exception {
                                   if (aBoolean){
                                       UiUtils.makeText(FlutterVideoDetailActivity.this,"视频已在缓存列表中");
                                   }else {
                                       downloadVideo();
                                   }
                               }
